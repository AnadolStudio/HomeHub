...
private fun getBorderlineColor(
    ...
    return when {
        error -> AppTheme.colors.template
...
private fun createSearchTextFieldColors(): TextFieldColors = TextFieldDefaults.textFieldColors(
    ...
    cursorColor = AppTheme.colors.template,
    trailingIconColor = AppTheme.colors.textPrimary,
    disabledTrailingIconColor = AppTheme.colors.template,
    errorTrailingIconColor = AppTheme.colors.textPrimary,
    placeholderColor = AppTheme.colors.textSecondary,
    disabledPlaceholderColor = AppTheme.colors.template,
)
