...
fun TextField(
    ...
    Column(modifier) {
        BaseTextField(
                ...
                readOnly = readOnly,
                textStyle = textStyle,
                label = { Text(text = labelText, style = textStyle, textAlign = TextAlign.Start) },
                placeholder = placeholder,
                leadingIcon = leadingIcon,
                trailingIcon = trailingIcon,
                isError = isError,
...
fun LargeTextField(
    ...
    Column(modifier = modifier) {
        BaseTextField(
                ...
                enabled = enabled,
                readOnly = readOnly,
                textStyle = textStyle.copy(textAlign = TextAlign.Justify),
                label = {
                    Text(
                            text = if (isRequired) {
                                labelText.addAsterisk()
                            } else {
            ...
            decorationBox = @Composable { innerTextField ->
                ...
                TextFieldDefaults.TextFieldDecorationBox(
                        ...
                        contentPadding = if (label == null) {
                            ...
                            textFieldWithLabelPadding(start = 0.dp)
                        }
                )
            }
    )
...
object AccountingTextFieldDefaults {
    ...
    fun textFieldColors(
            ...
            disabledTextColor: Color = AppTheme.colors.disable,
            backgroundColor: Color = Color.Transparent,
            cursorColor: Color = AppTheme.colors.colorAccent,
            errorCursorColor: Color = AppTheme.colors.colorError,
            focusedIndicatorColor: Color = AppTheme.colors.divider,
            unfocusedIndicatorColor: Color = AppTheme.colors.divider,
            disabledIndicatorColor: Color = AppTheme.colors.disable,
            errorIndicatorColor: Color = AppTheme.colors.colorError,
            leadingIconColor: Color = AppTheme.colors.colorAccent,
            disabledLeadingIconColor: Color = AppTheme.colors.disable,
            errorLeadingIconColor: Color = AppTheme.colors.colorAccent,
            trailingIconColor: Color = AppTheme.colors.colorAccent,
            disabledTrailingIconColor: Color = AppTheme.colors.disable,
            errorTrailingIconColor: Color = AppTheme.colors.colorAccent,
            focusedLabelColor: Color = AppTheme.colors.colorAccentAlternative,
            unfocusedLabelColor: Color = AppTheme.colors.colorAccentAlternative,
            disabledLabelColor: Color = AppTheme.colors.disable,
            errorLabelColor: Color = AppTheme.colors.colorError,
            placeholderColor: Color = AppTheme.colors.textSecondary,
            disabledPlaceholderColor: Color = AppTheme.colors.disable,
