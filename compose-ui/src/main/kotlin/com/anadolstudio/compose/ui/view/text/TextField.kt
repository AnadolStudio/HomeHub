...
object AccountingTextFieldDefaults {
    ...
    fun textFieldColors(
        ...
        disabledTextColor: Color = AppTheme.colors.textPrimary,
        backgroundColor: Color = Color.Transparent,
        cursorColor: Color = AppTheme.colors.template,
        errorCursorColor: Color = AppTheme.colors.template,
        focusedIndicatorColor: Color = AppTheme.colors.divider,
        unfocusedIndicatorColor: Color = AppTheme.colors.divider,
        disabledIndicatorColor: Color = AppTheme.colors.divider,
        errorIndicatorColor: Color = AppTheme.colors.template,
        leadingIconColor: Color = AppTheme.colors.textSecondary,
        disabledLeadingIconColor: Color = AppTheme.colors.template,
        errorLeadingIconColor: Color = AppTheme.colors.template,
        trailingIconColor: Color = AppTheme.colors.textPrimary,
        disabledTrailingIconColor: Color = AppTheme.colors.template,
        errorTrailingIconColor: Color = AppTheme.colors.textPrimary,
        focusedLabelColor: Color = AppTheme.colors.textPrimary,
        unfocusedLabelColor: Color = AppTheme.colors.textSecondary,
        disabledLabelColor: Color = AppTheme.colors.template,
        errorLabelColor: Color = AppTheme.colors.textSecondary,
        placeholderColor: Color = AppTheme.colors.textSecondary,
        disabledPlaceholderColor: Color = AppTheme.colors.template,
