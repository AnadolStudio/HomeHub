...
fun OutlineButtonLarge(
    ...
    enabled: Boolean = true,
    colors: AppButtonColors = AppButtonColors.outlineButtonColors(),
    maxLines: Int = 1,
    shape: Shape = MaterialTheme.shapes.tiny,
    contentPadding: PaddingValues = LargeButtonContentPadding,
    loading: Boolean = false,
...
fun FloatTextButton(
    ...
    TextButton(
        ...
        text = text,
        onClick = onClick,
        colors = AppButtonColors.primaryButtonColors(),
        icon = icon,
...
fun TextButton(
    ...
    modifier: Modifier = Modifier,
    enabled: Boolean = true,
    colors: AppButtonColors = AppButtonColors.textButtonColors(),
    shape: Shape = MaterialTheme.shapes.micro,
    contentPadding: PaddingValues = ButtonDefaults.TextButtonContentPadding,
    textStyle: TextStyle = AppTypography.textMedium18,
    loading: Boolean = false,
    icon: Painter? = null,
